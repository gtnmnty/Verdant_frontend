        ...
        <section id="home" className="relative overflow-hidden bg-[#d9b3ae] -mx-[10vw]">
            <div
                className="grid grid-cols-1 md:grid-cols-2 gap-6
                                md:gap-10 items-center px-[10vw]
                ...
                <div className="space-y-6 animate-[fadeIn_1s_ease-out]">
                 ...
                 text-[clamp(0.95rem,1.2vw,1.05rem)] max-w-md
                 leading-relaxed">
                    ...
                    <div className="flex flex-wrap gap-3 pt-2">
                        <button
                            ...
                            className="group inline-flex items-center gap-2
                                            rounded-full bg-stone-900 text-rose-50 px-6
                                            py-3 text-sm font-medium tracking-wide
                                            transition-all hover:bg-stone-800
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-full
                                            border border-stone-300 bg-white/60
                                            backdrop-blur px-6 py-3 text-sm font-medium
                                            text-stone-700 transition-all hover:bg-white
                ...
                <div className="relative h-[clamp(18rem,45vw,32rem)] flex

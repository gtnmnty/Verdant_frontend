                    ...
                    <div className="grid gap-4 py-2">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    onEditingChange({...editing, customer: e.target.value})}
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onValueChange={(v) =>
                                    onEditingChange({...editing, rating: Number(v)})}
                            >
                                <SelectTrigger>
                                    <SelectValue/>
                                </SelectTrigger>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    onEditingChange({...editing, reviewDate: e.target.value})}
                            />
                        </div>
                        <div>
                            <Label>Content</Label>
                            <Textarea
                                ...
                                onChange={(e) =>
                                    onEditingChange({...editing, content: e.target.value})}
                            />
                        </div>
                    </div>
                ) : null}

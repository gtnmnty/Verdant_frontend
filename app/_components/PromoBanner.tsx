...
export default function PromoBanner() {
    return (
        <Reveal>
            <section
                className="relative overflow-hidden rounded-[clamp(1rem,3vw,2rem)]
                bg-stone-900 text-rose-50 px-[clamp(1.5rem,5vw,4rem)] py-[clamp(2.5rem,6vw,5rem)] my-10">
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 items-center">
                    ...
                    <button
                        ...
                        className="rounded-full bg-rose-50 text-stone-900 px-6 py-3

...
export default function CollectionSection() {
    ...
    return (
        <section
            id="collection"
            className="bg-stone-50 -mx-[clamp(1rem,4vw,3rem)] px-[clamp(1rem,4vw,3rem)]
            py-[clamp(3rem,8vw,6rem)] rounded-[clamp(1rem,3vw,2rem)]"
        >
                    ...
                    <Reveal key={p.id} delay={i * 100}>
                        ...
                        >
                            ...
                            <div className="text-center space-y-2">
                                ...
                                <button
                                    className="text-[0.7rem] tracking-[0.3em] uppercase text-stone-700 border-b
                                    border-stone-300 pb-1 transition-colors hover:border-stone-700">
                                    Shop Now
                                </button>
                            </div>
                        </article>

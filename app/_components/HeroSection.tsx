...
export default function HeroSection() {
    return (
        <section id="home" className="relative overflow-hidden bg-[#d9b3ae] -mx-[10vw]">
            <div
                className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10
                items-center px-[10vw] py-[clamp(2rem,6vw,5rem)]">
                <div className="space-y-6 animate-[fadeIn_1s_ease-out]">
                    <SectionLabel>The Parfois Boutique</SectionLabel>
                    <h1 className="font-serif text-[clamp(2.25rem,6vw,4.5rem)]
                    leading-[1.05] text-stone-800 tracking-tight">
                    ...
                    <div className="flex flex-wrap gap-3 pt-2">
                        <button
                            ...
                            bg-stone-900 text-rose-50 px-6 py-3 text-sm font-medium
                            tracking-wide transition-all hover:bg-stone-800 hover:scale-[1.03]
                            hover:shadow-lg"
                        >
                        ...
                        <button
                            ...
                            border-stone-300 bg-white/60 backdrop-blur px-6 py-3
                            text-sm font-medium text-stone-700 transition-all
                ...
                <div className="relative h-[clamp(18rem,45vw,32rem)] flex items-end justify-center">
                    ...
                    <img
                        ...
                        className="relative z-10 h-full w-auto max-w-full object-cover
                        rounded-[2rem] shadow-2xl animate-[float_6s_ease-in-out_infinite]
